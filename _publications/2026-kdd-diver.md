...
Our contributions include algorithm implementation, experimental pipeline construction, attack and defense sample construction, hidden-state extraction, lightweight probe training, and evaluation across LLM backbones and RAG prompt settings.
